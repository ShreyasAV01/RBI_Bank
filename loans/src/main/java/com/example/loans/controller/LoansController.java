...
@Tag(name = "CRUD REST APIs for Loans in RBI",description = "CRUD REST APIs in RBI to CREATE, UPDATE, FETCH AND DELETE loan details")
@RestController
...
public class LoansController {
    ...
    @Operation(summary = "Fetch Loan Details REST API",description = "REST API to fetch loan details based on a loan number")
    ...
    public ResponseEntity<ResponseDto> updateLoanDetails(@RequestBody @Valid LoansDto loansDto){
        ...
        if (isUpdated){
            ...
            return ResponseEntity.status(HttpStatus.OK).body(new ResponseDto(LoansConstants.STATUS_417, LoansConstants.MESSAGE_417_UPDATE));
        }
    }
